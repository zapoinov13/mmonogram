...
for (const cadPreview of src.matchAll(/CAD_(?:BODY|GRILLE_KIT|INTERIOR|UPHOLSTERY|STEERING_CENTER|STEERING_CONTROLS|STEERING_DETAILS|DASHBOARD|CONSOLE|INSTRUMENTS|WHEELS)_URL\s*=\s*`\$\{MODEL_BASE\}([^`]+)`/g)) {
